...
class ReleaseTaskPlanningPage extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            showMarkAsCompleteConfirmationDialog: false,
            row: {},
    ...
    markAsComplete() {
        this.setState({ showMarkAsCompleteConfirmationDialog: false })
        this.props.markAsComplete(this.props.releasePlan)
    }
    ...
    render() {
        ...
        return (
            <div>
                <div className={!descriptionFlag ? "col-md-8 pad" : "col-md-12 pad"}>
                    ...
                    <div className="col-md-12 releasePlanChkBtn">
                        <div className="col-md-4 planBtn">
                            <button type="button" className="btn releasePlanTaskbtn"
                                onClick={() => this.setState({ showMarkAsCompleteConfirmationDialog: true })}>
                        ...
                        <div className="col-md-4">
                            <button type="button" className="btn releasePlanTaskbtn" style={{ marginRight: 0 }}
                                ...
                                {!descriptionFlag ? <i className="fa fa-arrow-right"></i> : <i className="fa fa-arrow-left"></i>}
                                {!descriptionFlag ? "Show Description" : "Hide Description"}
                            </button>
                        </div>
                    </div>
                    {
                    ...
                    {
                        this.state && this.state.showMarkAsCompleteConfirmationDialog &&
                        <ConfirmationDialog show={true}
                            onConfirm={this.markAsComplete.bind(this)}
                            title="Complete Release-Task"
                            onClose={this.closeMarkAsCompleteDialog.bind(this)}
                            body="This will mark whole 'release-task' as complete and would also mark last reported tasks of all employees as 'complete'" />
                    }
                    {!descriptionFlag ?
                        <div className="col-md-12">
