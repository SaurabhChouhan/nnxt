...
import {EstimationAddToReleaseFormContainer, ProjectFormContainer} from "../../containers"

const EstimationAddToReleaseDialog = (props) => {
    return <Modal className="estimationModal add-to-release-dialog" show={props.show} onHide={props.close}>
