...
let ReleaseDeveloperFilterForm = (props) => {
    const {change, days, team, handleSubmit, employeeId, startDate, endDate, baseDate, daysToShift, task} = props
        ...
        <div className="col-md-12 planDivider">
            ...
            <div className="col-md-7 planDividerBtn">
                ...
                <button
                    ...
                    onClick={() => {
                        props.shiftTasksToPast(employeeId, baseDate, daysToShift, task._id)
                    }}>
                    Shift in Past
                </button></div>
                <div className="col-md-6">
                <button
                    ...
                    onClick={() => {
                        props.shiftTasksToFuture(employeeId, baseDate, daysToShift, task._id)
                    }}>
                    Shift in Future
                </button>
