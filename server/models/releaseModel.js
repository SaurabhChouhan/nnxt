...
let releaseSchema = mongoose.Schema({
    ...
    iterations: [{
        ...
        unbilledAmount: { type: Number, default: 0 }, // sum of amount without added it into timesheet
        billingAmount: { type: Number, default: 0 }, // sum of amount added in timesheet for release
        billedAmount: { type: Number, default: 0 }, // sum of amount billed to client (timesheet is sent)
        paidAmount: { type: Number, default: 0 }, // sum of amount paid by client (timesheet is paid)
