...
leaveSchema.statics.saveLeave = async (leaveInput,user) => {
    ...
    if (!startDateMoment.isBefore(endDateMoment))
        throw new AppError("Leave start date should be less then or equal to end date", EC.INVALID_OPERATION, EC.HTTP_BAD_REQUEST)
