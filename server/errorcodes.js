...
export const CANT_COMPLETE = 'CANT_COMPLETE'
export const INSUFFICIENT_WORKING_DAYS = 'INSUFFICIENT_WORKING_DAYS'
export const MODULE_USED_IN_ESTIMATION = 'MODULE_USED_IN_ESTIMATION'
export const PROJECT_USED_IN_ESTIMATION = 'PROJECT_USED_IN_ESTIMATION'
export const CLIENT_USED_IN_ESTIMATION = 'CLIENT_USED_IN_ESTIMATION'
export const TECHNOLOGY_USED_IN_ESTIMATION = 'TECHNOLOGY_USED_IN_ESTIMATION'
export const NO_BILLING_RATE = 'NO_BILLING_RATE'
