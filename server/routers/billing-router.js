...
billingRouter.post('/billing-projects', async ctx => {
    V.validate(ctx.request.body, V.billingTaskBillingProjectStruct)
    return await MDL.BillingTaskModel.getBillingProjects(ctx.request.body, ctx.state.user)
})
