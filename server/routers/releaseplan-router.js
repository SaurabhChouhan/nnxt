...
releasePlanRouter.put('/:releasePlanID/mark-as-complete', async ctx => {
    return await MDL.ReleasePlanModel.markAsComplete(ctx.params.releasePlanID, ctx.state.user)
})
