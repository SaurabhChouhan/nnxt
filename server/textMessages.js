...
export const getApprovedLeaveMessage = compile("Your leave has been approved by Aripra Management Team.",true);
export const getRejectLeaveMessage = compile("Your leave has been rejected due to some reason. Please contact to Aripra Management Team.",true);
